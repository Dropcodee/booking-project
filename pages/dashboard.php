...
<body>
    ...
    <div class="users__section uk-container">
        ...
        <div class=" uk-child-width-expand@s uk-text-center uk-flex-cente" uk-grid>
                ...
                <div class="uk-container">
                    <div class="uk-grid-margin uk-grid uk-grid-stack" uk-grid>
                        <div class="uk-width-1-1@m">
                            <div class="uk-margin uk-width-large uk-margin-auto uk-card uk-card-default uk-card-large uk-card-body uk-box-shadow-large uk-flex-center">
                                <img class="uk-card-title card__avatar" src="../img/avatar.png" alt="new member" />
                                <form method="POST" autocomplete="off">
                                    <div class="uk-margin">
                                        <div class="uk-inline uk-width-1-1">
                                            <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: user"></span>
                                            <input class="uk-input uk-form-large" type="text" id="name" placeholder="Full Name" />
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <div class="uk-inline uk-width-1-1">
                                            <span class="uk-form-icon uk-form-icon-flip" uk-icon="icon: user"></span>
                                            <input class="uk-input uk-form-large" type="text" id="username" placeholder="User Name" />
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <div class="uk-inline uk-width-1-1">
                                    ...
                                    <div class="uk-margin">
                                        <div class="uk-inline uk-width-1-1">
                                            ...
                                            <input class="uk-input uk-form-large" type="text" id="webmail" placeholder="amaizing.blessing@lmu.edu.ng" />
                                        </div>
                                    </div>
                                    <div class="uk-margin">
                                        <div class="uk-inline uk-width-1-1">
                                    ...
                                    <div class="uk-margin">
                                        <button class="uk-button uk-button uk-button-large uk-width-1-1 lmu__btn__success uk-form-icon-flip"
    ...
    <!-- footer section -->
    <div class="uk-card uk-card-default uk-card-body lmu__footer" style="z-index: 980;" uk-sticky="offset: 100; bottom: #top">
        <div class="uk-grid-divider uk-child-width-expand@s" uk-grid>
            <div class="lmu__links">
                ...
                <div class="lmu__links__wrapper">
                    <ul>
                        <li>
                            <a href="https://lmu.edu.ng" target="_blank">Landmark University</a>
                        </li>
                        <li>
                            <a href="https://webmail2.lmu.edu.ng" target="_blank">Webmail</a>
                        </li>
                        <li>
                            <a href="https://internet.lmu.edu.ng" target="_blank">Internet Login</a>
                        </li>
                        <li>
